...
export function WalletActions() {
  const actions = [
    { to: '/dashboard/wallet/topup', icon: ArrowDownToLine, label: 'Recharger' },
    { to: '/dashboard/wallet/send', icon: Send, label: 'Envoyer' },
    { to: '/dashboard/wallet/pay', icon: ScanLine, label: 'Payer' },
    { to: '/dashboard/wallet/withdraw', icon: ArrowUpFromLine, label: 'Retirer' },
  ];
